...
ESCOPO_UM:
JOG_NOV1:
  OR DI,1 ; ATRIBUI AO REGISTRADOR DI O VALOR 1
  CALL JOGO_ROBO ; EXECUTA O PROCEDIMENTO DE MODO DE JOGO (HUMANO VS. ROBÔ)
  PERGUNTA_FINAL1 ; PERGUNTA SE O USUÁRIO DESEJA JOGAR NOVAMENTE
  JMP FIM_PROGRAMA ; SE O JOGADOR NÃO DESEJA JOGAR NOVAMENTE, ENCERRE O PROGRAMA

ESCOPO_ZERO:
JOG_NOV2:  
  CALL JOGO_MULTIPLAYER ; executa o procedimento de jogo multiplayer
  PERGUNTA_FINAL2  ; PERGUNTA SE O USUÁRIO DESEJA JOGAR NOVAMENTE
  JMP FIM_PROGRAMA ; SE O JOGADOR NÃO DESEJA JOGAR NOVAMENTE, ENCERRE O PROGRAMA 
